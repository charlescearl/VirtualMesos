...
export MESOS_FRAMEWORK_ID=201201191203-0-0000
export MESOS_EXECUTOR_URI=/spark-distro/spark-executor
export MESOS_USER=hduser
export MESOS_WORK_DIRECTORY=/mesos-distro/work/slaves/201201191203-0-0/frameworks/201201191203-0-0000/executors/default/runs/0
export MESOS_SLAVE_PID=slave@192.168.1.64:37023
...
export MESOS_SWITCH_USER=1
export MESOS_CONTAINER=hostvirkaz3-clone
mkdir -p /mesos-distro/work/slaves/201201191203-0-0/frameworks/201201191203-0-0000/executors/default/runs/0
